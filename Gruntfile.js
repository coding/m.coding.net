// Generated on 2014-12-15 using generator-mobile 1.0.0-alpha.2
'use strict';
            ...
            dist: {
                files: {
                    src: [
                        ...
                        '!<%= yeoman.dist %>/scripts/feedbackUploadImage.js',
        ...
        copy: {
            dist: {
                files: [{
                  ...
                  dest: '<%= yeoman.dist %>/scripts/feedbackUploadImage.js',
                  src: '<%= yeoman.app %>/scripts/feedbackUploadImage.js'
                },{
